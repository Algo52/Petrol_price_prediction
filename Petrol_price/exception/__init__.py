...
class ForcastException(Exception):
    ...
    def __init__(self,error_message:Exception,error_detail:sys) :
        ...
        self.error_message=ForcastException.get_detailed_error_message(error_message=error_message,
    ...
    def __repr__(self) -> str:
        return ForcastException.__name__.str()